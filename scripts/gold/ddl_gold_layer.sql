...
Script Purpose:
    ...
    Each view integrates data from multiple silver tables, and provides
    an easier column naming scheme to understand.

    Use the views for analytics and reporting.
=======================================================
*/
